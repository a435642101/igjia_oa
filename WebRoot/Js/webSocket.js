...
Ext.define('MessageContainer', {  
    ...
    receive : function(message) {  
        ...
        if(message.from == user){  
            ...
            $('#window-1036_header_hd-textEl').append(" <span class='msgnum' style='color:red;'>新消息</span>")
        }       
...
Ext.onReady(function() {
    ...
    function initWebSocket() {  
        if (window.WebSocket) {  
            websocket = new WebSocket(encodeURI('ws://yhtech.igjia.com/message?userid='+encodeURI(user)));  
