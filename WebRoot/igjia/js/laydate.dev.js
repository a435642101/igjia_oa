...
Dates.creation = function(ymd, hide){
    ...
    var condate = $(".contract_startdate").val();
	var conenddate = $(".contract_enddate").val();
	if(pay_date  == undefined){
		if(condate!=null && condate!="" && conenddate!=null && conenddate!=""){
	    	var now1 = new Date(condate);
	    	var now2 = new Date(conenddate);
	    	var month = now2.getMonth()-now1.getMonth();
	    	var year = now2.getFullYear()-now1.getFullYear();
	    	var contract_month = year*12+month;
	    	var countyear = Math.ceil(contract_month/12);
	    	$(".contract_month").val(contract_month);
	    	$(".lang").each(function(){
		...
		if(pay_date!=null && pay_date!="" && conenddate!=null && conenddate!=""){
			var now1 = new Date(pay_date);
	    	var now2 = new Date(conenddate);
	    	var month = now2.getMonth()-now1.getMonth();
	    	var year = now2.getFullYear()-now1.getFullYear();
	    	var contract_month = year*12+month;
